...
m4creladr   dw m4crom2+3,m4crom5+3,m4crom6+2,m4crom8+2,m4crom9+2,m4croma+2,m4cred1+3,m4cred2+2,m4cred3+3,m4csnd1+3,m4csnd2+3,m4crcv1+3,m4crcv2+3
m4creladr0
...
;        rst #28
        ...
        ld (m4csndx+1),a
        ld (m4crcvx+1),a
        ld hl,(m4cromhsn)   ;set send routine jumps
        ld (m4csnd7+1),hl
...
m4csndx ld bc,#df00
        out (c),c
m4csnd1 ld bc,(m4cromena)
        out (c),c
m4csnd2 ld ix,m4cred3
m4csnd3 ld a,0
m4csnd4 ld hl,0
m4csnd5 ld de,0
m4csnd6 db #fd:ld l,0
        ld bc,#7f00
m4csnd7 jp 0                ;hsend -> A=source bank, HL=source address, D-1,E=length, IYL=network daemon bank, IX=return address, BC=#7F00
